...
<div class="flex items-center justify-center min-h-screen bg-dark-950">
  <div class="w-full max-w-md p-8 rounded-lg shadow-xl bg-gray-800">
    <div class="text-center mb-6">
      <h1 class="text-2xl font-bold text-white mb-2">دانلود ها</h1>
      <p class="text-gray-400">دانلود اخربن ورژن</p>
    ...
    <div class="space-y-4">
      ...
      <div class="flex items-center p-4 rounded-lg bg-gray-700 hover:bg-gray-600 transition-colors">
        ...
        <div class="flex-1">
          <h3 class="font-medium text-white">64-bit Installer</h3>
          <p class="text-sm text-gray-400">windows</p>
        </div>
    ...
    <div class="flex items-center p-4 rounded-lg bg-gray-700 hover:bg-gray-600 transition-colors">
        ...
        <div class="flex-1">
          <h3 class="font-medium text-white">portable</h3>
          <p class="text-sm text-gray-400">windows</p>
        </div>
        <button class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-md transition-colors">
          Download
